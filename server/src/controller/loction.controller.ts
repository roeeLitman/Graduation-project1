...
export const getPlacesWithMostCasualties = async(req:Request<any,any,any,{city?:string}>,res:Response)=>{
    try {
        const topPlace = await placesWithMostCasualties(req.query.city)
