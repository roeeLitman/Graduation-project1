        ...
        useEffect(() => {
            const getTopLocations = async () => {
                ...
                if (Array.isArray(datafromApi)) {
                    ...
                    setData((prevData) => [...prevData, ...datafromApiWithOrganization]);
                }
            };
            getTopLocations();
        }, [selectOrganztion]);
  return (
    ...
    >
        ...
        <Stack spacing={2} direction="row" padding={2}>
            <TextField value={nameOfOrganiztion} onChange={(e) => setNameOfOrganiztion(e.target.value)} variant="filled" label="enter name of trore organization" />
            <Button onClick={handelOnClick} variant="contained">Select organization</Button>
        </Stack>
    </Stack>
    <Stack>
        <Map data={data} />
